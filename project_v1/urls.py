...
urlpatterns = [
    ...
    path('solicitudes_listado/', views.solicitudes_listado,
         name='solicitudes_listado'),
    ...
    path('solicitudes/eliminar/<int:solicitud_id>/',
         views.solicitud_eliminar, name='solicitud_eliminar'),
    path('solicitudes/calificar/<int:solicitud_id>/',
         views.solicitud_calificar, name='solicitud_calificar'),
    path('solicitudes/reportes/', views.solicitudes_reportes,
         name='solicitudes_reportes'),
    ...
    path('vehiculos/<int:vehiculo_id>/eliminar/',
         views.vehiculo_eliminar, name='vehiculo_eliminar'),
    ...
    path('clientes/<int:cliente_id>/',
         views.cliente_detalle, name='cliente_detalle'),
    path('clientes/<int:cliente_id>/eliminar/',
         views.cliente_eliminar, name='cliente_eliminar'),
    # path('vehiculos/reportes/', views.vehiculos_reportes, name='vehiculos_reportes'),
