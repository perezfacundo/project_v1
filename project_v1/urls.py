...
urlpatterns = [
    ...
    path('solicitudes/aceptar_presupuesto/<int:solicitud_id>/', views.aceptar_presupuesto, name='aceptar_presupuesto'),
    path('solicitudes/denegar_presupuesto/<int:solicitud_id>/', views.denegar_presupuesto, name='denegar_presupuesto'),
